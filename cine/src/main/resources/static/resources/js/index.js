...
document.addEventListener('DOMContentLoaded', async() => {
    ...
    //Cards
    const peliculas = await fetchData('https://vast-forest-06073.herokuapp.com/api/peliculas/list')
    const peliculasEstreno = await fetchData('https://vast-forest-06073.herokuapp.com/api/peliculas/list')
